    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_pic', models.ImageField(blank=True, null=True, upload_to='images/profile_pics/%Y/%m/%d/')),
                ...
                ('auth_type', models.CharField(choices=[('VIA_PHONE_NUMBER', 'Via Phone Number'), ('VIA_EMAIL', 'Via Email')], max_length=30)),
